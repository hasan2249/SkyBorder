<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        ...
        <a style="text-decoration: none" href="http://top4tech.net"><h3>TopTech</h3></a>
        <!-- <img class="navbar-brand-minimizedc="{{ asset('img/backend/brand/sygnet.svg') }}" width="30" height="30" alt="CoreUI Logo"> -->
    </a>
